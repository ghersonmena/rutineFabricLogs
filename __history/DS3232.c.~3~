...
void ds3232_init(void)
{
   ...
   i2c_start();
   i2c_write(0xD0);
   i2c_write(0x0E); // CONTROL REGISTER DS3232
   i2c_write(0x00); // square wave off
   i2c_stop();
}
...
void ds3232_get_date(BYTE &day, BYTE &mth, BYTE &year, BYTE &dow)
{
  i2c_start();
  i2c_write(0xD0);
...
void ds3232_get_time(BYTE &hr, BYTE &min, BYTE &sec)
{
  i2c_start();
  i2c_write(0xD0);
  i2c_write(0x00);            // Start at REG 0 - Seconds
...
int8 leer_temp_DS3232()
{
    BYTE msb, lsb;
    i2c_start();
    i2c_write(0xD0);
    i2c_write(0x11); // REG TEMP MSB
    i2c_start();
    i2c_write(0xD1);
    msb = i2c_read(1);
    lsb = i2c_read(0);
    i2c_stop();
    return msb; // solo grados enteros
}
